...
# # Scraper starts here - last run on Friday, Sep 18 2020, 6.55 pm.
...
aug = pd.read_csv('death_info_2020-08-14.csv')
sep = pd.read_csv('death_info_2020-09-19.csv')
...
merged = sep.merge(aug, on=cols, how='left', indicator=True)
...
l_only.to_csv(r'death_info_newsep19.csv')
...
sep_names = pd.read_csv('death_info_2020-09-19.csv')
sep_names.head()
...
sep_names.to_csv('death_info_2020-09-19_processed.csv')
